...
+ `dr_*`: icônes personnalisées DREAL
+ `la_*` : icôntes de la librairie [Line Awesome](https://icones8.fr/line-awesome)

```{r}
dr_fluidPage(
  tagList(
    dr_icons("la-jsfiddle"),
    dr_icons("drl-explosion", size = 2),
    dr_icons("drl-cadastre", size = 7, color = 'red')
  )
)
```
